...
private static final String HIGHLIGHT_ADDON = 
    ...
    @FXML 
    private void selectMedium() {              MusicController.playSound(MusicController.SOUND_CLICK);switchToGameBoard("Medium"); }
    
    @FXML 
    private void selectHard() {             MusicController.playSound(MusicController.SOUND_CLICK); switchToGameBoard("Hard"); }
